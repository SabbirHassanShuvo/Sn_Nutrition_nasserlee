<?php $__env->startSection('title', 'Offers & Campaigns'); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($product->id); ?>" data-image="<?php echo e($product->main_image ? asset($product->main_image) : asset('assets/images/no-image.png')); ?>">
...
<?php $__env->startPush('scripts-bottom'); ?>
    <script>
        (function ($) {
            $(function () {
                ...
                $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "<?php echo e(route('backend.offer.index')); ?>",
                    columns: [
                ...
                $('#offerForm').on('submit', function(e) {
                    e.preventDefault();
                    let id = $('#offer_id').val();
                    let url = id ? "<?php echo e(route('backend.offer.update', ':id')); ?>".replace(':id', id) : "<?php echo e(route('backend.offer.store')); ?>";
        ...
        function editOffer(id) {
            let url = "<?php echo e(route('backend.offer.show', ':id')); ?>".replace(':id', id);
        ...
        function changeStatus(id) {
            let url = "<?php echo e(route('backend.offer.status', ':id')); ?>".replace(':id', id);
            $.post(url, { _token: "<?php echo e(csrf_token()); ?>" }, function(response) {
                if (response.success) {
                    toastr.success(response.message);
                    $('.data-table').DataTable().ajax.reload();
                }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sandip\Herd\Sn_Nutrition_nasserlee\resources\views/backend/layout/offers/index.blade.php ENDPATH**/ ?>