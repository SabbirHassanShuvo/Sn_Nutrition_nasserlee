...
<?php $__env->startPush('scripts-bottom'); ?>
    <script>
        ...
        (function ($) {
            $(function () {
                $('.data-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "<?php echo e(route('backend.order.index')); ?>",
                    columns: [
                ...
                initBulkDelete("<?php echo e(route('backend.order.bulk-destroy')); ?>");
            });
        })(jQuery);

        function viewOrder(id) {
            currentOrderId = id;
            let url = "<?php echo e(route('backend.order.show', ':id')); ?>";
            $.ajax({
                type: "GET",
                    ...
                    if (response.success) {
                        ...
                        if (order.payment_method === 'bank_transfer') {
                            ...
                            if (bt) {
                                ...
                                let receiptUrl = bt.receipt_image ? ("<?php echo e(asset('')); ?>" + bt.receipt_image) : '';
        ...
        function updateOrderStatus() {
            ...
            let url = "<?php echo e(route('backend.order.status', ':id')); ?>";
            $.ajax({
                type: "POST",
        ...
        function verifyPayment(status) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = "<?php echo e(route('backend.order.verify-payment', ':id')); ?>";
                    $.ajax({
                        type: "POST",
                        url: url.replace(':id', currentOrderId),
                        data: { _token: "<?php echo e(csrf_token()); ?>", status: status },
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sandip\Herd\Sn_Nutrition_nasserlee\resources\views/backend/layout/orders/index.blade.php ENDPATH**/ ?>