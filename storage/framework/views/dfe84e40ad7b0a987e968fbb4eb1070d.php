...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card overflow-hidden">
                            <div class="row g-0">
                                ...
                                <!-- end col -->
                                <?php if(Route::is(['auth.reset.link.get','auth.reset.link.post'])): ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">Sign in to continue to <?php echo e($settings->app_name); ?>.</p>
                                        </div>
                                        ...
                                        <?php if(Route::is('login')): ?>
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Don't have an account ? <a href="<?php echo e(route('auth.signup.get')); ?>" class="fw-semibold text-primary text-decoration-underline"> Signup</a> </p>
                                            </div>
                                        <?php elseif(Route::is('signup.get')): ?>
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Already have an account ? <a href="<?php echo e(route('login')); ?>" class="fw-semibold text-primary text-decoration-underline"> login</a> </p>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
    ...
    <?php echo $__env->yieldPushContent('srcipts-bottom'); ?>

    
    <?php echo $__env->make('backend.partials.notifications', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

</body>
</html><?php /**PATH C:\Users\Sandip\Herd\Sn_Nutrition_nasserlee\resources\views/backend/layout/auth/auth-app.blade.php ENDPATH**/ ?>