<?php $__env->startSection('title', 'Specialist Management'); ?>
            ...
            <div class="card shadow-sm border-0" id="specialistList">
                <div class="card-header border-0 bg-white py-3 d-flex align-items-center justify-content-between">
                    ...
                    <div class="flex-shrink-0 d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('backend.specialist.create')); ?>" class="btn btn-primary btn-sm shadow-sm d-flex align-items-center">
    ...
    <script>
        $(document.body).ready(function() {
            var table = $('#specialistTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('backend.specialist.index')); ?>",
                columns: [
            ...
            $(document).on('change', '.status-toggle', function() {
                var id = $(this).data('id');
                $.ajax({
                    url: "<?php echo e(url('admin/specialist/status')); ?>/" + id,
                    type: "POST",
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(url('admin/specialist')); ?>/" + id,
                            type: "DELETE",
                            data: { _token: "<?php echo e(csrf_token()); ?>" },
                            success: function(res) {
            ...
            $('#bulkDeleteBtn').on('click', function() {
                ...
                if (ids.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "<?php echo e(route('backend.specialist.bulk-destroy')); ?>",
                                type: "DELETE",
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sandip\Herd\Sn_Nutrition_nasserlee\resources\views/backend/layout/specialists/index.blade.php ENDPATH**/ ?>