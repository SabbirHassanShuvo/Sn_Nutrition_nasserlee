<?php $__env->startSection('title', 'Consultation Bookings'); ?>
    ...
    <script>
        $(document.body).ready(function() {
            ...
            var table = $('#consultationTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('backend.consultation-booking.index')); ?>",
                    data: function(d) {
            ...
            $(document).on('click', '.generate-zoom-btn', function() {
                ...
                Swal.fire({
                    ...
                    preConfirm: function() {
                        return $.ajax({
                            url: "<?php echo e(url('admin/consultation-booking')); ?>/" + id + "/approve-zoom",
                            type: "POST",
            ...
            $(document).on('click', '.reject-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(url('admin/consultation-booking')); ?>/" + id + "/status",
                            type: "POST",
                            data: {
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sandip\Herd\Sn_Nutrition_nasserlee\resources\views/backend/layout/consultations/index.blade.php ENDPATH**/ ?>