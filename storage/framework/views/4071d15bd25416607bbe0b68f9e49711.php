                ...
                <form id="categoryForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="category_name" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="color" id="category_color_text" class="form-control border-start-0 border-end-0 shadow-none <?php $__errorArgs = ['color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="#FF8000" placeholder="#FF8000" maxlength="7" style="font-family: monospace; font-size: 15px; letter-spacing: 0.5px;">
...
<?php $__env->startPush('scripts-bottom'); ?>
    <script>
        (function ($) {
            $(function () {
                $('.data-table').DataTable({
                    ...
                    ajax: "<?php echo e(route('backend.category.index')); ?>",
                    columns: [
                ...
                initBulkDelete("<?php echo e(route('backend.category.bulk-destroy')); ?>");
            });
        })(jQuery);

        function showStatusChangeAlert(id) {
            let url = "<?php echo e(route('backend.category.status', ':id')); ?>";
            $.ajax({
                type: "POST",
        ...
        function openCreateModal() {
            ...
            $('#categoryForm').attr('action', "<?php echo e(route('backend.category.store')); ?>");
            $('#formMethod').val('POST');
            $('#category_id').val('');
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        let updateUrl = "<?php echo e(route('backend.category.update', ':id')); ?>".replace(':id', category.id);
                        ...
                        let imgUrl = category.image ? "<?php echo e(asset('')); ?>" + category.image : '';
                        resetDropify(imgUrl);
        ...
        <?php if($errors->any()): ?>
            $(document).ready(function() {
                $('#category_name').val("<?php echo e(old('name')); ?>");
                let oldColor = "<?php echo e(old('color', '#FF8000')); ?>";
                ...
                let oldId = "<?php echo e(old('category_id')); ?>";
                if (oldMethod === 'PATCH' && oldId) {
                    let updateUrl = "<?php echo e(route('backend.category.update', ':id')); ?>".replace(':id', oldId);
                    $('#categoryForm').attr('action', updateUrl);
                    $('#formMethod').val('PATCH');
...
<?php echo $__env->make('backend.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sandip\Herd\Sn_Nutrition_nasserlee\resources\views/backend/layout/categories/index.blade.php ENDPATH**/ ?>